...
class AudiobookMediaSessionCallback
    ...
    constructor(
            ...
            return when (loginState) {
                NOT_LOGGED_IN -> {
                    onSetPlaybackError(
                        ...
                        appContext.getString(local.oss.chronicle.core.R.string.auto_access_error_not_logged_in),
                    )
                    false
                }
                LOGGED_IN_NO_SERVER_CHOSEN -> {
                    onSetPlaybackError(
                        ...
                        appContext.getString(local.oss.chronicle.core.R.string.auto_access_error_no_server_chosen),
                    )
                    false
                }
                LOGGED_IN_NO_USER_CHOSEN -> {
                    onSetPlaybackError(
                        android.support.v4.media.session.PlaybackStateCompat.ERROR_CODE_NOT_SUPPORTED,
                        appContext.getString(local.oss.chronicle.core.R.string.auto_access_error_no_user_chosen),
                    )
                    false
                }
                LOGGED_IN_NO_LIBRARY_CHOSEN -> {
                    onSetPlaybackError(
                        android.support.v4.media.session.PlaybackStateCompat.ERROR_CODE_NOT_SUPPORTED,
                        appContext.getString(local.oss.chronicle.core.R.string.auto_access_error_no_library_chosen),
                    )
                    false
                }
        ...
        private fun checkAuthenticationOrErrorWithVoiceFeedback(): Boolean {
            ...
            return when (loginState) {
                NOT_LOGGED_IN -> {
                    val errorMessage = appContext.getString(local.oss.chronicle.core.R.string.error_not_logged_in_voice)
                ...
                LOGGED_IN_NO_SERVER_CHOSEN -> {
                    val errorMessage = appContext.getString(local.oss.chronicle.core.R.string.auto_access_error_no_server_chosen)
                    if (shouldPlayBridgeAudio) {
                        // Speak FIRST, then set error state AFTER TTS completes
                        voiceCommandBridgeAudio.speakErrorMessage(errorMessage) {
                            onSetPlaybackError(
                ...
                LOGGED_IN_NO_USER_CHOSEN -> {
                    val errorMessage = appContext.getString(local.oss.chronicle.core.R.string.auto_access_error_no_user_chosen)
                    if (shouldPlayBridgeAudio) {
                        // Speak FIRST, then set error state AFTER TTS completes
                        voiceCommandBridgeAudio.speakErrorMessage(errorMessage) {
                            onSetPlaybackError(
                ...
                LOGGED_IN_NO_LIBRARY_CHOSEN -> {
                    val errorMessage = appContext.getString(local.oss.chronicle.core.R.string.auto_access_error_no_library_chosen)
                    if (shouldPlayBridgeAudio) {
                        // Speak FIRST, then set error state AFTER TTS completes
                        voiceCommandBridgeAudio.speakErrorMessage(errorMessage) {
                            onSetPlaybackError(
        ...
        override fun onPlayFromSearch(
            ...
            serviceScope.launch(coroutineExceptionHandler) {
                try {
                    ...
                    onSetPlaybackError(
                        android.support.v4.media.session.PlaybackStateCompat.ERROR_CODE_APP_ERROR,
                        appContext.getString(local.oss.chronicle.core.R.string.auto_error_playback_failed),
                    )
                ...
                try {
                    ...
                    if (bookToPlay == EMPTY_AUDIOBOOK) {
                        ...
                        onSetPlaybackError(
                            ...
                            appContext.getString(local.oss.chronicle.core.R.string.auto_error_library_empty),
                        )
                        return
                    }
            ...
            try {
                ...
                if (matchingBooks.isNotEmpty()) {
                    ...
                    if (prefsRepo.voiceSearchFallbackEnabled) {
                        ...
                        onSetPlaybackError(
                            android.support.v4.media.session.PlaybackStateCompat.ERROR_CODE_NOT_AVAILABLE_IN_REGION,
                            appContext.getString(local.oss.chronicle.core.R.string.auto_error_no_results_for_query, query),
                        )
                    }
                }
            } catch (e: Exception) {
        ...
        override fun onPlayFromMediaId(
            ...
            if (bookId?.startsWith("__error") == true || bookId?.startsWith("__message") == true) {
                ...
                onSetPlaybackError(
                    android.support.v4.media.session.PlaybackStateCompat.ERROR_CODE_AUTHENTICATION_EXPIRED,
                    appContext.getString(local.oss.chronicle.core.R.string.auto_error_complete_required_steps_on_phone),
            ...
            try {
                ...
                if (bookId.isNullOrEmpty()) {
                    ...
                    onSetPlaybackError(
                        android.support.v4.media.session.PlaybackStateCompat.ERROR_CODE_APP_ERROR,
                        appContext.getString(local.oss.chronicle.core.R.string.auto_error_audiobook_not_available),
                    )
                    return
                }
        ...
        private fun resumePlayFromEmpty(playWhenReady: Boolean) {
            serviceScope.launch {
                try {
                    ...
                    onSetPlaybackError(
                        android.support.v4.media.session.PlaybackStateCompat.ERROR_CODE_APP_ERROR,
                        appContext.getString(local.oss.chronicle.core.R.string.auto_error_connection_timeout),
                    )
                } catch (e: Exception) {
